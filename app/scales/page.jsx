  ...
  try {
    ...
    if (res.ok) {
      ...
      for (const scale of freshScales) {
        ...
        const scaleDataRes = await fetch(`/api/scale-data/${scale.scale_id}`, {
          method: "POST",
        });
  ...
  <div className="relative p-6">
    ...
    {syncing && (
      <div className="absolute inset-0 bg-white bg-opacity-80 flex flex-col items-center justify-center z-50">
        ...
        <p className="mt-4 text-indigo-600 font-semibold">Syncing scales...</p>
      </div>
    )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {scales.map((scale) => (
          ...
          >
            ...
            <p className="text-sm text-gray-700">Scale ID: {scale.scale_id}</p>
    ...
    {selectedScaleData && (
      <div className="mt-8">
        ...
        <div className="flex mb-4">
          <button
            onClick={() => fetchScaleData(selectedScaleData.scale_id, "hourly")}
            className="bg-blue-600 text-white px-4 py-2 rounded mr-2"
          >
            Hourly Data
          </button>
          <button
            onClick={() => fetchScaleData(selectedScaleData.scale_id, "daily")}
