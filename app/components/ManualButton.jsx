// app/components/ManualButton.jsx
"use client";

export function ManualButton({ label = "Manual" }) {
  const onClick = () => window.dispatchEvent(new Event("toggle-help-manual"));
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-2 opacity-80 supports-[hover:hover]:hover:opacity-100"
